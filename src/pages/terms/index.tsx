...
const Terms = () => {
  return (
    <>
      <Head>
        <meta name="description" content={`Terms and Conditions for ${info.fullname}`} />
        <title>Terms and Conditions | BPG Albania</title>
      </Head>
        ...
        <section className={styles.section}>
          <div className="container">
            ...
            <div className={styles.textWrapper}>
              ...
              <p>
                These terms and conditions outline the rules and regulations for the use of {info.fullname} Website,
                located at https://
                {info.url}/.
              </p>
              ...
              <p>
                ...
                {info.fullname} if you do not agree to take all of the terms and conditions stated on this page.
              </p>
              ...
              <p>
                ...
                prevailing law of gb. Any use of the above terminology or other words in the singular, plural,
              ...
              <p>
                We employ the use of cookies. By accessing {info.fullname}, you agreed to use cookies in agreement with
                the {info.fullname}'s Privacy Policy.
              </p>
              ...
              <p>
                Unless otherwise stated, {info.fullname} and/or its licensors own the intellectual property rights for
                all material on {info.fullname}. All intellectual property rights are reserved. You may access this from{' '}
                {info.fullname} for your own personal use subjected to restrictions set in these terms and conditions.
              </p>
              ...
              <ul>
                ...
                <li>Reproduce, duplicate or copy material from {info.fullname}</li>
              ...
              <p>
                ...
                certain areas of the website. {info.fullname} does not filter, edit, publish or review Comments prior to
                their presence on the website. Comments do not reflect the views and opinions of {info.fullname},its
                agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and
                opinions. To the extent permitted by applicable laws, {info.fullname} shall not be liable for the
              ...
              <p>
                {info.fullname} reserves the right to monitor all Comments and to remove any Comments which can be
              ...
              <p>
                You hereby grant {info.fullname} a non-exclusive license to use, reproduce, edit and authorize others to
              ...
              <p>
                ...
                absence of {info.fullname}; and (d) the link is in the context of general resource information.
              </p>
              ...
              <p>
                ...
                website, you must inform us by sending an e-mail to {info.fullname}. Please include your name, your
              ...
              <p>
                No use of {info.fullname}'s logo or other artwork will be allowed for linking absent a trademark license
                agreement.
              </p>
