          ...
          <div className="container">
            ...
            <div className={styles.textWrapper}>
              ...
              <ul>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to {info.fullname}, accessible from{' '}
                    <a href={`https://${info.url}/`} rel="external nofollow noopener" target="_blank">
                      https://{info.url}/
                    </a>
                  </p>
                </li>
